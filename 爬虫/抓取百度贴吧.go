...
func spider(start, end int) {
	...
	for i := start; i <= end; i++ {
		url := "https://tieba.baidu.com/f?kw=%E7%8E%8B%E8%80%85%E8%8D%A3%E8%80%80&ie=utf-8&cid=&tab=corearea&pn="+strconv.Itoa(50 * (i - 1))
		...
		//将抓取到的内容写到文件中
		file, err := os.OpenFile("index"+strconv.Itoa(i)+".html", os.O_CREATE|os.O_WRONLY, 0755)
		if err != nil {
